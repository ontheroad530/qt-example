...
void SmileyItem::edit()
{
	...
	createMenuAction(&menu, QIcon(":/images/smileysmile.png"),
		tr("Happy"), m_face == Happy, group, Happy);
	createMenuAction(&menu, QIcon(":/images/smileyneutral.png"),
		tr("Neutral"), m_face == Neutral, group, Neutral);
	createMenuAction(&menu, QIcon(":/images/smileysad.png"),
...
QVariant SmileyItem::itemChange(GraphicsItemChange change, const QVariant& value)
{
...
QAction* SmileyItem::createMenuAction(QMenu* menu, const QIcon& icon,
	const QString& text, bool checked, QActionGroup* group, const QVariant& data)
{
