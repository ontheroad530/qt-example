...
void TextEdit::createWidgets()
{
    ...
    boldAction = fontToolBar->addAction(QIcon(":/images/bold.png"),
                                        tr("Bold"));
    boldAction->setCheckable(true);
    boldAction->setShortcut(tr("Ctrl+B"));
    italicAction = fontToolBar->addAction(QIcon(":/images/italic.png"),
                                          tr("Italic"));
    italicAction->setCheckable(true);
    italicAction->setShortcut(tr("Ctrl+I"));
    colorAction = fontToolBar->addAction(QIcon(":/images/color.png"),
                                         tr("Color"));
